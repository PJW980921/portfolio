      ...
      <section className="flex justify-center items-center flex-col mb-16 ">
        <BlurFade delay={0.25} inView>
          <div className="flex justify-center items-center flex-col font-bmHannaAir text-[16px] text-center">
            ...
            <br />
            실무 경험을 통해 소통의 중요성을 더욱 깊이 체감하게 되었으며,
            <br />
            더 나은 소통 능력을 기르기 위해 퇴근 후 주도적인 학습과
            <br />
            <div className="flex flex-row gap-2">
            <p>타 직군들과의 소통 경험을 쌓기 위해 다양한 <Link href="/projects" target="_blank" className="text-orange-400">협업 프로젝트</Link>에
            참여하고 있습니다.
            </p>
            </div>
            소통 능력과 기술 역량을 함께 향상시키기 위해 꾸준히 노력하고 있습니다.
            <br />
            향후 협업에 있어 유연하고 효과적으로 소통할 수 있는 개발자가 되는 것이 목표입니다.
            <br />
            감사합니다.
          </div>
        </BlurFade>
