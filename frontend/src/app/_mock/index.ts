...
import JavaIcon from "../../../public/images/svgs/Java-Light.svg";
import SpringIcon from "../../../public/images/svgs/Spring-Light.svg";
import PostgreSQLIcon from "../../../public/images/svgs/PostgreSQL-Light.svg";
...
export const informationList: InformationListProps = {
  ...
  skills: {
    ...
    Backend: [
      { id: 6, src: JavaIcon, alt: "JavaIcon" },
      { id: 7, src: SpringIcon, alt: "SpringIcon" },
    ],
    DB: [{ id: 8, src: PostgreSQLIcon, alt: "PostgreSQLIcon" }],
    Styling: [{ id: 9, src: TailwindIcon, alt: "TailwindIcon" }],
    Libraries: [
      { id: 10, src: ReactQueryIcon, alt: "React\nQueryIcon" },
      { id: 11, src: ReactHookFormIcon, alt: "React\nHook\nFormIcon" },
      { id: 12, src: AxiosIcon, alt: "AxiosIcon" },
    ],
    "CI/CD": [
      { id: 13, src: GitHubIcon, alt: "GitHubIcon" },
      { id: 14, src: GitIcon, alt: "GitIcon" },
      { id: 15, src: VercelIcon, alt: "VercelIcon" },
      { id: 16, src: NetlifyIcon, alt: "NetlifyIcon" },
    ],
  },
};
...
export const careerList: CareerProps[] = [
  {
    ...
    projects: [
      {
        id: 0,
        title: "국토안전관리원 - 건설공사 품질관리 종합정보 시스템",
        date: "(2025-03-10 ~ 2026-01-15)",
        tag: "백엔드 개발",
        link: "https://gcloud.csi.go.kr/cmq/main.do",
        description: [
